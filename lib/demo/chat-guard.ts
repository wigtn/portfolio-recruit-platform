 ...
 *    스스로 부순다.
 * 4. 개인정보 입력과 폼 제출. 상담 폼에는 이름과 연락처가 들어간다.
 *    챗봇은 그 화면을 열어줄 뿐 대신 채우거나 보내지 않는다.
...
export const REFUSED: Record<string, string> = {
  ...
  fill_contact: "연락처는 제가 대신 적지 않아요. 직접 입력해 주세요.",
  submit_contact: "상담 신청은 내용을 확인하시고 직접 보내주셔야 해요.",
